...
function renderizarProductos(stock) {
...
function filtrar() {
  let stockProductos = stockProductos.filter(prod => prod.nombre.toLowerCase().includes(buscador.value.toLowerCase()))
  renderizarProductos(productosss)
}
...
function eliminarProducto(id) {
  const juegosId = id;
  carrito = carrito.filter((juegos) => juegos.id !== juegosId);
  mostrarCarrito();
}
